#ifndef OPTIONS_PARSER_DECONV_HH_INCLUDED
#define OPTIONS_PARSER_DECONV_HH_INCLUDED
 ...
 **/
class options_parser_deconv : public options_parser
{
 public:
...
#endif // OPTIONS_PARSER_DECONV_HH_INCLUDED
