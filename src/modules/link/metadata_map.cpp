...
template< typename meta_retriever >
void create_prot_map( std::unordered_map<std::string, std::unordered_set< scored_entity<std::string, double>>>& scores_map,
                                   std::vector<sequence>& sequences,
                                   meta_retriever retrieve_id )
    {
        // verify file
